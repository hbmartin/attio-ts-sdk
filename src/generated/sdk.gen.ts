...
export const getV2Files = <ThrowOnError extends boolean = false>(options: Options<GetV2FilesData, ThrowOnError>) => (options.client ?? client).get<GetV2FilesResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await zGetV2FilesData.parseAsync(data),
...
export const postV2Files = <ThrowOnError extends boolean = false>(options: Options<PostV2FilesData, ThrowOnError>) => (options.client ?? client).post<PostV2FilesResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await zPostV2FilesData.parseAsync(data),
...
export const postV2FilesUpload = <ThrowOnError extends boolean = false>(options: Options<PostV2FilesUploadData, ThrowOnError>) => (options.client ?? client).post<PostV2FilesUploadResponses, unknown, ThrowOnError>({
    ...
    requestValidator: async (data) => await zPostV2FilesUploadData.parseAsync(data),
...
export const deleteV2FilesByFileId = <ThrowOnError extends boolean = false>(options: Options<DeleteV2FilesByFileIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteV2FilesByFileIdResponses, DeleteV2FilesByFileIdErrors, ThrowOnError>({
    requestValidator: async (data) => await zDeleteV2FilesByFileIdData.parseAsync(data),
...
export const getV2FilesByFileId = <ThrowOnError extends boolean = false>(options: Options<GetV2FilesByFileIdData, ThrowOnError>) => (options.client ?? client).get<GetV2FilesByFileIdResponses, GetV2FilesByFileIdErrors, ThrowOnError>({
    requestValidator: async (data) => await zGetV2FilesByFileIdData.parseAsync(data),
...
export const getV2FilesByFileIdDownload = <ThrowOnError extends boolean = false>(options: Options<GetV2FilesByFileIdDownloadData, ThrowOnError>) => (options.client ?? client).get<unknown, unknown, ThrowOnError>({
    requestValidator: async (data) => await zGetV2FilesByFileIdDownloadData.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getScimV2Users = <ThrowOnError extends boolean = false>(options?: Options<GetScimV2UsersData, ThrowOnError>) => (options?.client ?? client).get<GetScimV2UsersResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await zGetScimV2UsersData.parseAsync(data),
...
export const postScimV2Users = <ThrowOnError extends boolean = false>(options?: Options<PostScimV2UsersData, ThrowOnError>) => (options?.client ?? client).post<PostScimV2UsersResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await zPostScimV2UsersData.parseAsync(data),
...
export const getScimV2Groups = <ThrowOnError extends boolean = false>(options?: Options<GetScimV2GroupsData, ThrowOnError>) => (options?.client ?? client).get<GetScimV2GroupsResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await zGetScimV2GroupsData.parseAsync(data),
...
export const postScimV2Groups = <ThrowOnError extends boolean = false>(options?: Options<PostScimV2GroupsData, ThrowOnError>) => (options?.client ?? client).post<PostScimV2GroupsResponses, unknown, ThrowOnError>({
    requestValidator: async (data) => await zPostScimV2GroupsData.parseAsync(data),
